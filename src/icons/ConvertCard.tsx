...
const ConvertCard: React.FC<IconWrapperProps> = ({ color = 'currentColor', set = 'outline', strokeWidth }) => {
    const Bold = () => (
        <g>
            ...
            <path d="M22 4.2V4.31C22 4.59 21.78 4.81 21.5 4.81H12.5C12.22 4.81 12 4.59 12 4.31V4.2C12 2.44 12.44 2 14.22 2H19.78C21.56 2 22 2.44 22 4.2Z" fill="#292D32" />
            <path d="M12.5 5.80859C12.22 5.80859 12 6.02859 12 6.30859V7.30859V8.29859C12 10.0586 12.44 10.4986 14.22 10.4986H19.78C21.56 10.4986 22 10.0586 22 8.29859V7.30859V6.30859C22 6.02859 21.78 5.80859 21.5 5.80859H12.5Z" fill="#292D32" />
            <path d="M12 15.7V15.81C12 16.09 11.78 16.31 11.5 16.31H2.5C2.22 16.31 2 16.09 2 15.81V15.7C2 13.94 2.44 13.5 4.22 13.5H9.78C11.56 13.5 12 13.94 12 15.7Z" fill="#292D32" />
            <path d="M2.5 17.3086C2.22 17.3086 2 17.5286 2 17.8086V18.8086V19.7986C2 21.5586 2.44 21.9986 4.22 21.9986H9.78C11.56 21.9986 12 21.5586 12 19.7986V18.8086V17.8086C12 17.5286 11.78 17.3086 11.5 17.3086H2.5Z" fill="#292D32" />
        </g>
    )
    ...
    const Bulk = () => (
        <g>
            ...
            <path d="M2 16.3101V17.8101V19.8001C2 21.5601 2.44 22.0001 4.22 22.0001H9.78C11.56 22.0001 12 21.5601 12 19.8001V17.8101V16.3101H2Z" fill="#292D32" />
            <path opacity="0.4" d="M22 4.2V4.81H12V4.2C12 2.44 12.44 2 14.22 2H19.78C21.56 2 22 2.44 22 4.2Z" fill="#292D32" />
            <path d="M12 4.81006V6.31006V8.30006C12 10.0601 12.44 10.5001 14.22 10.5001H19.78C21.56 10.5001 22 10.0601 22 8.30006V6.31006V4.81006H12Z" fill="#292D32" />
        </g>
    )
    const Linear = () => (
        <g>
    ...
    const Outline = () => (
        <g>
            <path d="M22 6.31006H12C11.59 6.31006 11.25 5.97006 11.25 5.56006C11.25 5.15006 11.59 4.81006 12 4.81006H22C22.41 4.81006 22.75 5.15006 22.75 5.56006C22.75 5.98006 22.41 6.31006 22 6.31006Z" fill="#292D32" />
            ...
            <path d="M12 17.8101H2C1.59 17.8101 1.25 17.4701 1.25 17.0601C1.25 16.6501 1.59 16.3101 2 16.3101H12C12.41 16.3101 12.75 16.6501 12.75 17.0601C12.75 17.4801 12.41 17.8101 12 17.8101Z" fill="#292D32" />
